...
import { AiOutlineMenu, AiOutlineHome, AiTwotoneAccountBook }  from 'react-icons/ai'
...
const Sidenav = () => {
  ...
  return (
    <div>
      <AiOutlineMenu onClick={handleNave} className='absolute top-4 right-4 z-[99] md:hidden'/>
      {
        nav ? (
